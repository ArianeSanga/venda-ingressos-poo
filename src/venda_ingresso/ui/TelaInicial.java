...
public class TelaInicial extends JDialog {
    ...
    public TelaInicial() {
        // R14 - tenta desserializar ingressos ao abrir, se nao existir inicia lista vazia
        ingressos = (ArrayList<Ingresso>) GerenciadorArquivo.desserializar("ingressos.ser");
